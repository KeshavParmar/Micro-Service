...
public class CurrencyConversionController {
	...
	public CurrencyConversion calculateCurrencyConversion(
		...
		discoveryClient.getInstances("currency-exchange").forEach((ServiceInstance s) -> {
	...
	public CurrencyConversion calculateCurrencyConversionFeign(
		...
		CurrencyConversion currencyConversion = currencyConversionProxy.retrieveCurrencyExchange(from, to);
		return new CurrencyConversion(currencyConversion.getId(), from, to,
				currencyConversion.getConversionMultiple(),quantity,
